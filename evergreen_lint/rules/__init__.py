...
from evergreen_lint.rules.prevent_tasks_with_tag_on_variants import (
    PreventTasksWithTagOnVariants,
)
...
RULES: Dict[str, Type[Rule]] = {
    ...
    "prevent-tasks-with-tag-on-variants": PreventTasksWithTagOnVariants,
}
