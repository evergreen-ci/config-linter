...
class TestEnforceTasksDistroWithSpecialTag(unittest.TestCase):
    ...
    #             {
    #                 "task_tag_name": "requires_large_host",
    #                 "allowed_distro_regex": "(.*-xlarge|.*-large|.*-medium)",
    #             },
    #             {
    #                 "task_tag_name": "requires_metal",
    #                 "allowed_distro_regex": ".*-metal",
    #             },
    #         ]
    #     }
    ...
    #     violations = self.rule(config, yaml)
    #     self.assertEqual(len(violations), 2)
    #     self.assertIn("requires_large_host", violations[0])
    #     self.assertIn("requires_metal", violations[1])
